...
.. code-block:: python
    ...
    from geolabel_maker.downloads import MapBoxAPI
...
from geolabel_maker.rasters.functions import merge
...
class MapBoxAPI(Downloader):
    ...
    * :attr:`access_token` (str): User token.
    ...
    def georeference(x, y, z, tile_file, out_file):
        ...
        Returns:
            str: Path to the georeferenced tile.
            
        Examples:
            If ``ACCESS_TOKEN`` is a valid token from your mapbox account, 
    ...
    def download_tile(self, x, y, z, high_res=True, out_file="mapbox.png"):
        ...
        Examples:
            ...
            Download the tile ``17/66391/45088`` (in Slippy Map format):
    ...
    def download_image(self, lat, lon, zoom, high_res=True, out_file="mapbox.tif"):
        ...
        Returns:
            str: Path to the downloaded georeferenced image.
        ...
        Examples:
            ...
            Download the georeferenced image from its geographic coordinates:
    ...
    def download(self, bbox, zoom, width=10_240, height=10_240, high_res=True, slippy_maps=False,
        ...
        Examples:
            ...
            Download images (tiles or georeferenced rasters) from a bounding box with:        
